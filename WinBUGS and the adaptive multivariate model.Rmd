...
ggplot(edges_sf, aes(x = edge_value_ABYM_10, y = edge_value_NSRW1_10, 
...
ggplot(edges_sf, aes(x = edge_value_ABYM_20, y = edge_value_NSRW1_20, 
                     color = factor(inter_region_edges))) +
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
...
ggplot(edges_sf, aes(x = edge_value_ABYM_50, y = edge_value_NSRW1_50, 
                     color = factor(inter_region_edges))) +
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
...
ggplot(edges_sf, aes(x = edge_value_ABYM_86, y = edge_value_NSRW1_86, 
                     color = factor(inter_region_edges))) +
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
