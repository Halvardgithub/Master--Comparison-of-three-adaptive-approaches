...
```{r}
res_list_NSRW1 <- readRDS("Results//result_list_NSRW1.rds")
...
edgeplot <- ggarrange(plotlist = edgeplots, ncol = 2, nrow = 4, labels = NULL)

final_edgeplot <- annotate_figure(edgeplot,
                              top = text_grob("Precision for each edge in the graph", 
                              face = "bold", size = 30))
...
tau_list <- res_list_NSRW1[[1]]$mean$Tau2
...
tau_list <- res_list_NSRW1[[2]]$mean$Tau2
...
tau_list <- res_list_NSRW1[[3]]$mean$Tau2
...
tau_list <- res_list_NSRW1[[4]]$mean$Tau2
...
precplot <- ggarrange(plotlist = precplots, ncol = 2, nrow = 4, labels = NULL)

final_precplot <- annotate_figure(precplot,
                              top = text_grob("Total precision for each province", 
                              face = "bold", size = 30))
...
SCplot_edges_10 <- ggplot(edges_sf, aes(x = edge_value_ABYM_10, y = edge_value_NSRW1_10, 
  ...
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
       title = paste("Cor =", round(cor_edges_10, 3))) + 
...
SCplot_edges_20 <- ggplot(edges_sf, aes(x = edge_value_ABYM_20, y = edge_value_NSRW1_20, 
  ...
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
       title = paste("Cor =", round(cor_edges_20, 3))) + 
  scale_color_manual(values = c("0" = "red", "1" = "blue")) +
  guides(color = "none")
...
SCplot_edges_50 <- ggplot(edges_sf, aes(x = edge_value_ABYM_50, y = edge_value_NSRW1_50, 
  ...
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
       title = paste("Cor =", round(cor_edges_50, 3))) + 
  scale_color_manual(values = c("0" = "red", "1" = "blue")) +
  guides(color = "none")
...
SCplot_edges_86 <- ggplot(edges_sf, aes(x = edge_value_ABYM_86, y = edge_value_NSRW1_86, 
  ...
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
       title = paste("Cor =", round(cor_edges_86, 3))) + 
  scale_color_manual(values = c("0" = "red", "1" = "blue")) +
  guides(color = "none")
...
SCplot_prec_10 <- ggplot(ss_provinces, aes(x = color10_ABYM, y = color10_NSRW1)) +
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
       title = paste("Cor =", round(cor_prec_10, 3)))
...
SCplot_prec_20 <- ggplot(ss_provinces, aes(x = color20_ABYM, y = color20_NSRW1)) +
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
       title = paste("Cor =", round(cor_prec_20, 3)))
...
SCplot_prec_50 <- ggplot(ss_provinces, aes(x = color50_ABYM, y = color50_NSRW1)) +
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
       title = paste("Cor =", round(cor_prec_50, 3)))
...
SCplot_prec_86 <- ggplot(ss_provinces, aes(x = color86_ABYM, y = color86_NSRW1)) +
  geom_point() +
  labs(x = "Adaptive BYM", y = "Temporal NSRW1", 
       title = paste("Cor =", round(cor_prec_86, 3)))
```
...
# ann1 <- ggplot() + 
#   geom_text(aes(x=0, y=0, label = "bold(Edges)"), 
#             parse = TRUE, size = 5, hjust = 0) +
#   theme_void()
# 
# ann2 <- ggplot() + 
#   geom_text(aes(x=0, y=0, label = "bold(Regions)"), 
#             parse = TRUE, size = 5, hjust = 0) +
#   theme_void()
...
scatterplot <- ggarrange(plotlist = scatterplots, ncol = 2, nrow = 4, labels = NULL)

final_scatterplot <- annotate_figure(scatterplot,
                        top = text_grob("Edges and precision per Province", 
                        face = "bold", size = 30))
final_scatterplot
...
anova_edge_table_figure <- annotate_figure(anova_edge_table, top = text_grob("p-values for edges", face = "bold", size = 14))

#ggsave("Plots//anovaFigure.png", plot = anova_edge_table_figure, height = 12, width = 10,  units = "cm",  dpi = 300)
```
...
anova_log_edge_table_figure <- annotate_figure(anova_log_edge_table, top = text_grob("p-values for log of the edges", face = "bold", size = 14))

#ggsave("Plots//anovaLogFigure.png", plot = anova_log_edge_table_figure, height = 12, width = 10,  units = "cm",  dpi = 300)
```
...
Pretty breaks did nothing in the edgeplots
