...
#ggsave("Plots//CV_plot_DIC_example.png", plot = DIC_boxplot, height = 9, width = 17,  units = "cm",  dpi = 300)

#ggsave("Plots//RW_edgeplot_example.png", plot = edgeplot_ABYM_86, height = 12, width = 15,  units = "cm",  dpi = 300)
```
