...
#saveRDS(criteria_df, file = "CV-Results//CV_no_iidTheta_W_C.rds")

#saveRDS(criteria_df, file = "CV-Results//CV_no_iidTheta_PC_W_C.rds")
```
...
res_df <- readRDS(file = "CV-Results//CV_no_iidTheta.rds")

#res_df <- readRDS(file = "CV-Results//CV_no_iidTheta_PC.rds")

index_WAIC <- c(1, 2, 3, 4, 5, 6, 7, 8, 25, 28, 31)

index_DIC <- c(9, 10, 11, 12, 13, 14, 15, 16, 26, 29, 32)

index_CPO <- c(17, 18, 19, 20, 21, 22, 23, 24, 27, 30, 33)

desired_order <- c("ICAR", "BW", "BW_2","RW_10", "EW_10","RW_20", "EW_20", 
                       "RW_50","EW_50", "RW_86", "EW_86")
...
```{r}
#Gamma prior
#ggsave("Plots//Plots_withScaling_and_without_iidTheta//CV_boxplot_W_outliers.png", plot = full_boxplot, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta//CV_boxplot_ICAR_ref_W_outliers.png", plot = full_boxplot_W_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta//CV_boxplot_ICAR_ref_WO_outliers.png", plot = full_boxplot_WO_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta//CV_boxplot_ICAR_ref_cancer_WO_outliers.png", plot = full_boxplot_cancer_WO_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

#PC prior
#ggsave("Plots//Plots_withScaling_and_without_iidTheta//CV_boxplot_PC_W_outliers.png", plot = full_boxplot, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta//CV_boxplot_PC_ICAR_ref_W_outliers.png", plot = full_boxplot_W_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta//CV_boxplot_PC_ICAR_ref_WO_outliers.png", plot = full_boxplot_WO_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta//CV_boxplot_PC_ICAR_ref_cancer_WO_outliers.png", plot = full_boxplot_cancer_WO_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)
```
