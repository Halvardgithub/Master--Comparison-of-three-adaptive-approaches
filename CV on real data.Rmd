...
```{r}
library(INLA)
#res_list_testing <- readRDS("Results//result_list_RW.rds")
...
# INLA:::inla.ginv(Q_RW10)
# image(Q_RW10)
# diag(INLA:::inla.ginv(Q_RW10))
 
 # rowSums(Q_RW10)
 # Q_RW10[1, 8]
 # edges_df$edge_value_RW_10[1]
...
RW10_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_RW10, nAreas = nAreas, pr_str = prior_str)
RW20_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_RW20, nAreas = nAreas, pr_str = prior_str)
RW50_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_RW50, nAreas = nAreas, pr_str = prior_str)
RW86_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_RW86, nAreas = nAreas, pr_str = prior_str)
RW_C_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_RW_Cancer, nAreas = nAreas, pr_str = prior_str)

EW10_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_EW10, nAreas = nAreas, pr_str = prior_str)
EW20_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_EW20, nAreas = nAreas, pr_str = prior_str)
EW50_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_EW50, nAreas = nAreas, pr_str = prior_str)
EW86_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_EW86, nAreas = nAreas, pr_str = prior_str)
EW_C_model <- inla.rgeneric.define(inla.rgeneric.Adaptive.ICAR, R = Q_EW_Cancer, nAreas = nAreas, pr_str = prior_str)
```
