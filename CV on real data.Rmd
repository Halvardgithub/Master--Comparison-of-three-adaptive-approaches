...
for (j in test_indecies){
  ...
  if (prior_str == "PC"){
    ...
    formula_ICAR <- Y ~ offset(log(E)) + 
      f(ID, model = "besag", graph = adj_matrix, scale.model = TRUE, log = TRUE)
  }
...
NOTE: when addign cancer models I made the ICAR use a pc.prior, and forgot to make it flexible, so the gamma validation with cancer is wrong as the ICAR has a differnt prior than the rest.

```{r}
# save the criteria_df
prior_str

#saveRDS(criteria_df, file = "CV-Results//CV_no_iidTheta_W_C_3.rds")

#saveRDS(criteria_df, file = "CV-Results//CV_no_iidTheta_PC_W_C_3.rds")
```
...
#res_df <- readRDS(file = "CV-Results//CV_no_iidTheta_W_C_3.rds")

res_df <- readRDS(file = "CV-Results//CV_no_iidTheta_PC_W_C_3.rds")
...
```{r}
#Gamma prior
#ggsave("Plots//Plots_withScaling_and_without_iidTheta_2//CV_boxplot_W_outliers.png", plot = full_boxplot, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta_2//CV_boxplot_ICAR_ref_W_outliers.png", plot = full_boxplot_W_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta_2//CV_boxplot_ICAR_ref_WO_outliers.png", plot = full_boxplot_WO_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

#ggsave("Plots//Plots_withScaling_and_without_iidTheta_2//CV_boxplot_ICAR_ref_cancer_WO_outliers.png", plot = full_boxplot_cancer_WO_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

#PC prior
ggsave("Plots//Plots_withScaling_and_without_iidTheta_3//CV_boxplot_PC_W_outliers.png", plot = full_boxplot, height = 24, width = 21,  units = "cm",  dpi = 300)

ggsave("Plots//Plots_withScaling_and_without_iidTheta_3//CV_boxplot_PC_ICAR_ref_W_outliers.png", plot = full_boxplot_W_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

ggsave("Plots//Plots_withScaling_and_without_iidTheta_3//CV_boxplot_PC_ICAR_ref_WO_outliers.png", plot = full_boxplot_WO_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)

ggsave("Plots//Plots_withScaling_and_without_iidTheta_3//CV_boxplot_PC_ICAR_ref_cancer_WO_outliers.png", plot = full_boxplot_cancer_WO_outliers, height = 24, width = 21,  units = "cm",  dpi = 300)
```
