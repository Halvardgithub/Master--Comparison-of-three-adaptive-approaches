...
library(readr)
Expected_cases <- read_csv("ExpectedCasesMiguel.csv")

#Mortality
Mortality_df <- read.csv("Data/Mortality.csv", sep=";")
Mortality_df$Provincia.de.residencia[4]

Mortality_df2 <- read_excel("Data/Mortality.xlsx")
